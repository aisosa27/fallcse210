...
// Getter for word count
        ...
        public void changeGuess(string userInput)
        {
            for(int i = 0; i < currentWord.Length; i++)
            {
                if(userInput[0] == currentWord[i])
                {
                    guess[i] = userInput;
                }
            }
